...
![](images/flujo_s1.png){fig-align="center"}
...
: R cuenta con una amplia gama de paquetes diseñados específicamente para el análisis de datos espaciales, como 'sf', 'sp', 'raster' y 'leaflet'. Esto facilita la implementación de técnicas espaciales sin necesidad de reinventar la rueda.

2. Visualización avanzada: 
: R ofrece herramientas gráficas de alta calidad para la representación visual de datos espaciales. Paquetes como 'ggplot2' y 'tmap' permiten crear mapas y gráficos personalizados con facilidad.
